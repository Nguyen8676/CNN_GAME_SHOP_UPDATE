...
namespace Webbangame.Models
{
    ...
    partial void DeleteTHE_LOAI(THE_LOAI instance);
		...
		public System.Data.Linq.Table<AVARTA> AVARTAs
		{
			get
			{
				return this.GetTable<AVARTA>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AVARTA")]
	public partial class AVARTA
	{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LOGO", DbType="Char(20)")]
		public string LOGO
		{
			get
			{
    ...
    partial void OnFaceBookChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FaceBook", DbType="Char(100)")]
